...
class Chaser(QuidditchPlayer):
    ...
    def energy(self, time):
        ...
        338.0
        """
        self.energy = self.base_energy - self.goals * self.energy_expended
        if time % 9 == 0:
            self.energy = self.energy - 0.1 * self.energy_expended
        return self.energy
...
class Seeker(QuidditchPlayer):
    ...
    def energy(self, time):
        ...
        550
        """
        self.energy = self.base_energy - time * self.energy_expended
        return self.energy
...
class Keeper(QuidditchPlayer):
    ...
    def energy(self, time):
        ...
        if time < 30:
            ...
            self.energy = self.base_energy - self.energy_expended * 0.8 * (time// 15)
        return self.energy  
